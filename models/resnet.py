...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=100):
        ...
        self.linear = nn.Linear(512*block.expansion*((32//32)**2), num_classes)
    ...
    def freeze_model(self):
        self._freeze_layer(self.conv1, freeze=True)
        self._freeze_layer(self.bn1, freeze=True)
        self._freeze_layer(self.layer1, freeze=True)
        self._freeze_layer(self.layer2, freeze=True)
        self._freeze_layer(self.layer3, freeze=True)
        self._freeze_layer(self.layer4, freeze=True)
        self._freeze_layer(self.linear, freeze=True)
    ...
    def reinitialize_last_layer_weights(self):
