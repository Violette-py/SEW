...
[![arXiv](https://img.shields.io/badge/arXiv-2602.03377-b31b1b.svg?logo=arxiv&logoColor=white)](https://arxiv.org/abs/2602.03377)
[![Hugging Face](https://img.shields.io/badge/Hugging%20Face-SEW-FFD21E.svg?logo=huggingface&logoColor=black)](https://huggingface.co/Violette-py/SEW)
...
For responsible release considerations, as discussed in the paper's **Ethical Considerations** section, the open-source link is provided in a gated format. Therefore, the code is hosted on Hugging Face with access review enabled.
